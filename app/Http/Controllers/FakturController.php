...
class FakturController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->id)) {
            ...
            try {
                ...
                $data = $this->fakturService->updateFaktur($id, $request->all());
    ...
    {
        try {
            $action = $this->fakturService->deleteFaktur($id);
