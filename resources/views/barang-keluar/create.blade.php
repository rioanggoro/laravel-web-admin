                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="mt-2 alert alert-danger d-none" role="alert" id="alert-tanggal_keluar">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kode_transaksi" id="kode_transaksi"
                                    readonly>
                                <div class="mt-2 alert alert-danger d-none" role="alert" id="alert-kode_transaksi">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2 alert alert-danger d-none" role="alert" id="alert-stok"></div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2 alert alert-danger d-none" role="alert" id="alert-customer_id"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="mt-2 alert alert-danger d-none" role="alert" id="alert-jumlah_keluar">
                                    </div>
                                </div>
                            </div>
